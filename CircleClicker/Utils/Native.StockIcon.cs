...
namespace CircleClicker.Utils
{
    ...
    public static partial class Native
    {
        ...
        {
            /// <summary>
            /// The <see cref="SHSTOCKICONINFO.szPath"/> and <see cref="SHSTOCKICONINFO.iIcon"/> members of the <see cref="SHSTOCKICONINFO"/> structure receive the path and icon index of the requested icon, in a format suitable for passing to the <see cref="System.Drawing.Icon.ExtractIcon"/> function. The numerical value of this flag is zero, so you always get the icon location regardless of other flags.
            /// </summary>
            ...
            /// <summary>
            /// The <see cref="SHSTOCKICONINFO.iSysIconIndex"/> member of the <see cref="SHSTOCKICONINFO"/> structure receives the index of the specified icon in the system imagelist.
            /// </summary>
            ...
            /// <summary>
            /// Modifies the <see cref="SHGSI_SELECTED"/> value by causing the function to blend the icon with the system highlight color.
            /// </summary>
            SHGSI_SELECTED = 0x000010000,

            /// <summary>
            /// Modifies the <see cref="SHGSI_ICON"/> value by causing the function to retrieve the large version of the icon, as specified by the SM_CXICON and SM_CYICON system metrics.
            /// </summary>
...
#pragma warning restore CA1069 // Enums values should not be duplicated
            ...
            /// <summary>
            /// Modifies the <see cref="SHGSI_ICON"/> value by causing the function to retrieve the small version of the icon, as specified by the SM_CXSMICON and SM_CYSMICON system metrics.
            /// </summary>
            SHGSI_SMALLICON = 0x000000001,

            /// <summary>
            /// Modifies the <see cref="SHGSI_LARGEICON"/> or <see cref="SHGSI_SMALLICON"/> values by causing the function to retrieve the Shell-sized icons rather than the sizes specified by the system metrics.
            /// </summary>
            SHGSI_SHELLICONSIZE = 0x000000004
        }

        /// <summary>
        /// Used by <see cref="SHGetStockIconInfo"/> to identify which stock system icon to retrieve.<br />
        /// A list of icons is available <see href="https://learn.microsoft.com/en-us/windows/win32/api/shellapi/ne-shellapi-shstockiconid#constants">here</see>.
        /// </summary>
        public enum SHSTOCKICONID : uint
        {
            ...
            /// <summary><b>Windows Vista with Service Pack 1 (SP1) and later.</b> High definition DVD drive (any type - HD DVD-ROM, HD DVD-R, HD-DVD-RAM) that uses the HD DVD format.</summary>
            SIID_DRIVEHDDVD = 132,

            /// <summary><b>Windows Vista with SP1 and later.</b> High definition DVD drive (any type - BD-ROM, BD-R, BD-RE) that uses the Blu-ray Disc format.</summary>
            SIID_DRIVEBD = 133,

            /// <summary><b>Windows Vista with SP1 and later.</b> High definition DVD-ROM media in the HD DVD-ROM format.</summary>
            SIID_MEDIAHDDVDROM = 134,

            /// <summary><b>Windows Vista with SP1 and later.</b> High definition DVD-R media in the HD DVD-R format.</summary>
            SIID_MEDIAHDDVDR = 135,

            /// <summary><b>Windows Vista with SP1 and later.</b> High definition DVD-RAM media in the HD DVD-RAM format.</summary>
            SIID_MEDIAHDDVDRAM = 136,

            /// <summary><b>Windows Vista with SP1 and later.</b> High definition DVD-ROM media in the Blu-ray Disc BD-ROM format.</summary>
            SIID_MEDIABDROM = 137,

            /// <summary><b>Windows Vista with SP1 and later.</b> High definition write-once media in the Blu-ray Disc BD-R format.</summary>
            SIID_MEDIABDR = 138,

            /// <summary><b>Windows Vista with SP1 and later.</b> High definition read/write media in the Blu-ray Disc BD-RE format.</summary>
            SIID_MEDIABDRE = 139,

            /// <summary><b>Windows Vista with SP1 and later.</b> A cluster disk array.</summary>
        ...
        /// <summary>
        /// Receives information used to retrieve a stock Shell icon. This structure is used in a call to <see cref="SHGetStockIconInfo"/>.
        /// </summary>
...
#pragma warning disable IDE1006 // Naming Styles
            ...
            /// </summary>
            public uint cbSize = (uint)Marshal.SizeOf<SHSTOCKICONINFO>();

            /// <summary>
            /// When <see cref="SHGetStockIconInfo"/> is called with the <see cref="SHGSI.SHGSI_ICON"/> flag, this member receives a handle to the icon.
            /// </summary>
            public nint hIcon;

            /// <summary>
            /// When <see cref="SHGetStockIconInfo"/> is called with the <see cref="SHGSI.SHGSI_SYSICONINDEX"/> flag, this member receives the index of the image in the system icon cache.
            /// </summary>
            public int iSysIconIndex;

            /// <summary>
            /// When <see cref="SHGetStockIconInfo"/> is called with the <see cref="SHGSI.SHGSI_ICONLOCATION"/> flag, this member receives the index of the icon in the resource whose path is received in <see cref="szPath"/>.
            /// </summary>
            public int iIcon;

            /// <summary>
            /// When <see cref="SHGetStockIconInfo"/> is called with the <see cref="SHGSI.SHGSI_ICONLOCATION"/> flag, this member receives the path of the resource that contains the icon. The index of the icon within the resource is received in <see cref="iIcon"/>.
            /// </summary>
...
#pragma warning restore IDE1006 // Naming Styles
        ...
        /// <param name="psii">A reference to a <see cref="SHSTOCKICONINFO"/> structure.</param>
        /// <returns>If this function succeeds, it returns <b>S_OK</b> (<c>0</c>). Otherwise, it returns an <b>HRESULT</b> error code.</returns>
